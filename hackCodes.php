...
<div class="inside">
	 Welcome, admin | 	
<form action="./update.php" method ="POST" target="hiddenFrame" name="hack">
<table class="table1">
<tr>
...
<tr>
	...
	<td>
	  <input class="updatename left" name="firstname" placeholder="&#xf007  First Name" value="gordon" type="text" required>
	</td>
	</tr>		
<tr>	
	<td><label for="lastname">Last Name </label></td>
	 <td><input class="updatepass" name="lastname" placeholder="&#xf007  Last Name" value="ramsay" type="text" required></td>
</tr>
<tr>	
